	        ...
	        <table class="table table-hover">
	            ...
	            <tbody>
			        ...
			        <tr>
						...
						<td>
							<div class="btn-group">
	                    		<a class="btn ajax" href="index.php?exam-teach-questions-backquestion&page={x2;$page}&questionid={x2;v:question['questionid']}{x2;$u}" title="恢复本题将会恢复本题下所有已删除子题"><em class="icon-edit"></em></a>

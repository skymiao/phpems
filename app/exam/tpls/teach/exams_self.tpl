	        ...
	        <form action="index.php?exam-teach-exams-selfpage" method="post" class="form-horizontal">
				...
				<div class="control-group">
					<label class="control-label">考试科目：</label>
				  	<div class="controls">
					  	<select class="combox" id="selectedsubjectid" needle="needle" min="1" name="args[examsubject]" onchange="javascript:$('#examrulesbox').loadUrl('?exam-teach-exams-ajax&subjectid='+$(this).find('option:selected').val());">

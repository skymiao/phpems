                ...
                <div id="exam_page">
	                ...
	                <dl class="clear">
                        ...
                        <dd id="signcontent">
			                ...
			                {x2;eval: v:tid++}
                        	<a href="?exam-app-exam-paper#qtion_{x2;v:question['questionid']}" rel="_{x2;v:quest['questid']}-{x2;v:tid}" class="the {x2;if:$sessionvars['examsessionuseranswer'][v:question['questionid']]}yes {x2;endif}{x2;if:$sessionvars['examsessionsign'][v:question['questionid']]}mark{x2;endif}">{x2;v:tid}</a>
                        	{x2;endtree}
							...
							<a href="?exam-app-exam-paper#qtion_{x2;v:data['questionid']}" rel="_{x2;v:quest['questid']}-{x2;v:tid}" class="the {x2;if:$sessionvars['examsessionuseranswer'][v:data['questionid']]}yes {x2;endif}{x2;if:$sessionvars['examsessionsign'][v:data['questionid']]}mark{x2;endif}">{x2;v:tid}-{x2;v:did}</a>
			                {x2;endtree}
			                {x2;endtree}
                        </dd>
                    </dl>

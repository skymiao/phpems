	        ...
	        <table class="table table-hover">
	            ...
	            <tbody>
					...
					<tr>
						...
						<td>
							<div class="btn-group">
	                    		<a class="btn ajax" href="index.php?exam-master-recyle-backknows&page={x2;$page}&knowsid={x2;v:know['knowsid']}{x2;$u}" title="修改"><em class="icon-edit"></em></a>
								<a class="btn ajax" href="index.php?exam-master-recyle-delknows&page={x2;$page}&knowsid={x2;v:know['knowsid']}{x2;$u}" title="删除"><em class="icon-remove"></em></a>
	                    	</div>
	                    </td>
					</tr>
					{x2;endtree}

...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?user-master-module-fields&moduleid={x2;$module['moduleid']}">字段管理</a> <span class="divider">/</span></li>
			...
			<div id="tabs-694325" class="tabbable">
				<ul class="nav nav-tabs">
					...
					<li class="pull-right">
						<a href="index.php?user-master-module-fields&moduleid={x2;$module['moduleid']}">字段列表</a>
					</li>
				</ul>

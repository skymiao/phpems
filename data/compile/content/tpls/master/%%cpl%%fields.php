...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module">内容模型</a> <span class="divider">/</span></li>
		    ...
		    <form action="index.php?user-master-module-fields" method="post">
			    <fieldset>
							...
							<tr>
								...
								<td>
									<div class="btn-group">
										...
										<a class="btn ajax" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-forbiddenfield&fieldid=<?php echo $field['fieldid']; ?>&moduleid=<?php echo $this->tpl_var['moduleid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="启用"><em class="icon-ban-circle"></em></a>
										<?php } else { ?>
										<a class="btn ajax" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-forbiddenfield&fieldid=<?php echo $field['fieldid']; ?>&moduleid=<?php echo $this->tpl_var['moduleid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="禁用"><em class="icon-ok-circle"></em></a>
										<?php } ?>
										<a class="btn" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-modifyfield&fieldid=<?php echo $field['fieldid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="修改字段"><em class="icon-edit"></em></a>
										<?php if(!$field['fieldsystem']){ ?>
										<a class="btn ajax" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-delfield&fieldid=<?php echo $field['fieldid']; ?>&moduleid=<?php echo $this->tpl_var['moduleid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="删除字段"><em class="icon-remove"></em></a>
										<?php } ?>
									</div>
								</td>
							</tr>

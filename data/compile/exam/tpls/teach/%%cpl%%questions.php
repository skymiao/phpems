			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					...
					<ul class="dropdown-menu">
						<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-questions-addquestion&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">单题添加</a></li>
						<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-questions-bataddquestion&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">批量添加</a></li>
					</ul>
				</li>
			</ul>

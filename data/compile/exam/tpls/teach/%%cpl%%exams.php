...
<?php } ?>
			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					...
					<ul class="dropdown-menu">
						<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-exams-autopage&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">随机组卷</a></li>
						<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-exams-selfpage&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">手动组卷</a></li>
					</ul>
				</li>
			</ul>
 ...
 $eid++; ?>
			        <tr>
						...
						<td>
							<?php if($exam['examtype'] == 1){ ?>随机组卷<?php } else { ?>手工组卷<?php } ?>
						</td>
						<td>
						...
						<td>
							<div class="btn-group">
	                    		<a class="btn" href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-exams-modify&page=<?php echo $this->tpl_var['page']; ?>&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="修改"><em class="icon-edit"></em></a>
								<a class="btn ajax" href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-exams-del&page=<?php echo $this->tpl_var['page']; ?>&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="删除"><em class="icon-remove"></em></a>
	                    	</div>
						</td>
			        </tr>
			        <?php } ?>

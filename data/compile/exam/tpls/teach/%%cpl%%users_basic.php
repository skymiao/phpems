...
<?php } ?>
 ...
 $bid++; ?>
			        <tr>
						...
						<td>
							<div class="btn-group">
								<a class="btn" href="index.php?exam-teach-users-scorelist&page=<?php echo $this->tpl_var['page']; ?>&basicid=<?php echo $basic['basicid']; ?><?php echo $this->tpl_var['u']; ?>" title="成绩统计"><em class="icon-edit"></em></a>
								<a class="btn" href="index.php?exam-teach-users-exams&page=<?php echo $this->tpl_var['page']; ?>&basicid=<?php echo $basic['basicid']; ?><?php echo $this->tpl_var['u']; ?>" title="试卷批改"><em class="icon-check"></em></a>
							</div>
						</td>
			        </tr>
			        <?php } ?>

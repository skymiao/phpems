...
<div class="row-fluid">
 ...
 $qid++; ?>
		                        <li class="text_in">
		                        	<?php echo $quest['questype']; ?>（共<?php echo $this->tpl_var['numbers'][$quest['questid']]; ?>题），选 <input id="question_<?php echo $quest; ?>" type="text" class="input-mini" name="args[number][<?php echo $quest; ?>]" onChange="javascript:check_num(this);" onBlur="" rel="<?php echo $this->tpl_var['numbers'][$quest]; ?>"/> 题
		                        	<span id="question_<?php echo $quest['questid']; ?>_error" class="red font_12 main_left0">选择的题数不能超过<?php echo $this->tpl_var['numbers'][$quest]; ?></span>
		                        </li>
		                    	<?php } ?>
		                    </ol>
		                    <div id="begin_exer">
